...
impl ThreadManager {
    ...
    pub(crate) fn with_code_mode_host_program_for_tests(self, host_program: PathBuf) -> Self {
        self.with_code_mode_session_provider_for_tests(Arc::new(
            ProcessOwnedCodeModeSessionProvider::with_host_program(host_program),
        ))
    }

    pub(crate) fn with_code_mode_session_provider_for_tests(
        mut self,
        ...
        state.code_mode_session_provider = session_provider;
        self
    }
