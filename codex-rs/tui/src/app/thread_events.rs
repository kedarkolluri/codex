    ...
    pub(super) fn event_survives_session_refresh(event: &ThreadBufferedEvent) -> bool {
        matches!(
            ...
            ThreadBufferedEvent::Request(_)
                ...
                | ThreadBufferedEvent::Notification(ServerNotification::WorkflowStarted(_))
                | ThreadBufferedEvent::Notification(ServerNotification::WorkflowPhaseChanged(_))
                | ThreadBufferedEvent::Notification(ServerNotification::WorkflowGroupStarted(_))
                | ThreadBufferedEvent::Notification(ServerNotification::WorkflowGroupCompleted(_))
                | ThreadBufferedEvent::Notification(ServerNotification::WorkflowAgentStarted(_))
                | ThreadBufferedEvent::Notification(ServerNotification::WorkflowAgentBound(_))
                | ThreadBufferedEvent::Notification(ServerNotification::WorkflowAgentUpdated(_))
                | ThreadBufferedEvent::Notification(ServerNotification::WorkflowAgentCompleted(_))
                | ThreadBufferedEvent::Notification(ServerNotification::WorkflowLog(_))
                | ThreadBufferedEvent::Notification(ServerNotification::WorkflowCompleted(_))
