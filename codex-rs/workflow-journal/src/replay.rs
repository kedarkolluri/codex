...
impl OversizedLegacyAgentCall {
    fn validate_and_link(self, link: OversizedLegacyAgentLink) -> io::Result<OversizedLegacyAgentLink> {
    ...
    fn parse_oversized_legacy_line(
        ...
        match kind {
            LegacyRecordKind::AgentCall => {
                ...
                let mut link_record =
                    Vec::with_capacity(original_prefix_len + return_offset + 1);
...
mod tests {
    ...
    fn scanner_rejects_schema_invalid_oversized_legacy_agent_calls() {
        ...
        let invalid_type = valid.replacen(
            "\"tokens_spent\":1000",
